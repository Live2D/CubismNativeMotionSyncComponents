...
public:
     ...
     * @return 解析結果のインスタンス
     */
    CubismMotionSyncEngineAnalysisResult* Analyze(csmVector<csmFloat32> &samples, csmInt32 beginIndex, csmFloat32 blendRatio, csmInt32 smoothing, csmFloat32 audioLevelEffectRatio, CubismMotionSyncEngineAnalysisResult* result);
     ...
     * @return 解析結果のインスタンス
     */
    CubismMotionSyncEngineAnalysisResult* Analyze(csmVector<csmFloat32> &samples, csmInt32 beginIndex, csmFloat32 blendRatio, csmInt32 smoothing, csmFloat32 audioLevelEffectRatio);
