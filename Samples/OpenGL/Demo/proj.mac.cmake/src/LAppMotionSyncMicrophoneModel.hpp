...
/**
  ...
  *
  */
class LAppMotionSyncMicrophoneModel : public Csm::CubismUserModel
{
public:
    /**
     * @brief コンストラクタ
     */
    LAppMotionSyncMicrophoneModel(Csm::csmString executeAbsolutePath);

    /**
     * @brief デストラクタ
     *
     */
    virtual ~LAppMotionSyncMicrophoneModel();
...
private:
    Csm::csmString _executeAbsolutePath; ///< 実行中のプログラムファイルパス
    ...
    LAppMicrophoneAudioManager _soundData; ///< モーションシンクで使用する音声データ
