...
public:
    ...
    * @return  クラスのインスタンス
    */
    static LAppMicrophoneDelegate* GetInstance();
...
private:
    ...
    */
    ...
    LAppMotionSyncMicrophoneModel* _userModel; ///< ユーザーが実際に使用するモデル
...
public:
    ...
    */
    ...
    {
        LAppMicrophoneDelegate::GetInstance()->OnMouseCallBack(window, button, action, modify);
    }
    ...
    */
    ...
    {
         LAppMicrophoneDelegate::GetInstance()->OnMouseCallBack(window, x, y);
    }
